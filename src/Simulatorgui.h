...
class SimulatorBase : public wxFrame
{
	...
	protected:
		...
		wxStaticText* m_staticTextKnots122111111;
		wxStaticText* m_staticText81111111;
		wxStaticText* m_staticTextKnots111111111;
		wxStaticText* m_staticText18121111;
		wxStaticText* m_staticTextKnots11111111132;
		wxStaticText* m_staticTextKnots111111111122;
		wxStaticText* m_staticTextKnots111111111222;
		wxStaticText* m_staticTextKnots1111111111122;
		wxStaticText* m_staticTextKnots1111111112112;
		wxStaticText* m_staticTextKnots11111111111112;
	...
	public:
		...
		wxSpinCtrl* m_spSatQuant;
		wxSpinCtrl* m_spSatHDOP;
		wxSpinCtrl* m_spGPSAntBow;
		wxSpinCtrl* m_spSatAntBeam;
		wxStaticText* m_stGPSHeading;
		wxStaticText* m_stGPSSpeed;
		wxStaticText* m_stGPSETA;
		wxStaticText* m_stGPSDistance;
		wxStaticText* m_stGPSLatD1;
		wxStaticText* m_stGPSLatD1m;
		wxStaticText* m_stGPDLatD1s;
		wxStaticText* m_stGPSLongD1;
		wxStaticText* m_stGPSLongD1m;
		wxStaticText* m_stGPSLongD1s;
		wxStaticText* m_stGPSLatD2;
		wxStaticText* m_stGPSLatD2m;
		wxStaticText* m_stGPSLongD2;
		wxStaticText* m_stGPSLongDm;
		wxStaticText* m_stGPSLatD3;
		wxStaticText* m_stGPSLongD3;
		...
		SimulatorBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Vessel Data Message Simulator"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 826,624 ), long style = wxCAPTION|wxCLOSE_BOX|wxDEFAULT_FRAME_STYLE|wxFRAME_FLOAT_ON_PARENT|wxFRAME_NO_TASKBAR|wxRESIZE_BORDER|wxSYSTEM_MENU|wxTAB_TRAVERSAL );
