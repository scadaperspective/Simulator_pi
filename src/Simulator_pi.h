...
#define     PLUGIN_VERSION_DATE 2019-05-14
...
#define Simulator_TOOL_POSITION    -1          // Request default positioning of toolbar tool

class Simulator_pi : public opencpn_plugin_16 //  
{
public:
      Simulator_pi(void *ppimgr);
	   ~Simulator_pi(void);
...
//    Other public methods
      void SetSimulatorDialogX         (int x){ m_hr_dialog_x = x;};
      void SetSimulatorDialogY         (int x){ m_hr_dialog_y = x;};
      void SetSimulatorDialogWidth     (int x){ m_hr_dialog_width = x;};
      void SetSimulatorDialogHeight    (int x){ m_hr_dialog_height = x;};  
	  void SetSimulatorDialogSizeX     (int x){ m_hr_dialog_sx = x; }
	  void SetSimulatorDialogSizeY     (int x){ m_hr_dialog_sy = x; }
	  void OnSimulatorDialogClose();
