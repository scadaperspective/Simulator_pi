///////////////////////////////////////////////////////////////////////////
// C++ code generated with wxFormBuilder (version May 29 2019)
...
SimulatorBase::SimulatorBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_spSat1 = new wxSpinCtrl( sbSizer63->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 999, 4 );
	m_spSat1->SetToolTip( _("Sattelite #1 ID#") );

	fgSizer108131->Add( m_spSat1, 0, wxALL, 2 );
	...
	m_spSat2 = new wxSpinCtrl( sbSizer63->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 999, 18 );
	m_spSat2->SetToolTip( _("Sattelite #2 ID#") );

	fgSizer108131->Add( m_spSat2, 0, wxALL, 2 );
	...
	m_spSat3 = new wxSpinCtrl( sbSizer63->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 999, 22 );
	m_spSat3->SetToolTip( _("Sattelite #3 ID#") );

	fgSizer108131->Add( m_spSat3, 0, wxALL, 2 );
	...
	m_spSat4 = new wxSpinCtrl( sbSizer63->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 999, 24 );
	m_spSat4->SetToolTip( _("Sattelite #4 ID#") );

	fgSizer108131->Add( m_spSat4, 0, wxALL, 2 );
	...
	m_staticText13411311 = new wxStaticText( sbSizer63->GetStaticBox(), wxID_ANY, _("Visible"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText13311121 = new wxStaticText( sbSizer63->GetStaticBox(), wxID_ANY, _("A/B Geoid"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText1341111311 = new wxStaticText( sbSizer63->GetStaticBox(), wxID_ANY, _("ANT Pos"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	fgSizer2881 = new wxFlexGridSizer( 2, 1, 0, 0 );
	fgSizer2881->SetFlexibleDirection( wxBOTH );
	fgSizer2881->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxStaticBoxSizer* sbLongS2;
	sbLongS2 = new wxStaticBoxSizer( new wxStaticBox( m_panelGPS, wxID_ANY, _("COG Bearing  / SOG Speed") ), wxVERTICAL );

	wxFlexGridSizer* fgSizer2211112;
	fgSizer2211112 = new wxFlexGridSizer( 0, 8, 0, 0 );
	fgSizer2211112->SetFlexibleDirection( wxBOTH );
	fgSizer2211112->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_stGPSHeading = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("000.0"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSHeading->Wrap( -1 );
	m_stGPSHeading->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSHeading->SetToolTip( _("Vessel Heading") );

	fgSizer2211112->Add( m_stGPSHeading, 0, wxALL, 1 );

	m_staticTextKnots122111111 = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("ºt"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots122111111->Wrap( -1 );
	m_staticTextKnots122111111->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer2211112->Add( m_staticTextKnots122111111, 0, wxALL, 1 );

	m_stGPSSpeed = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("000.00"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSSpeed->Wrap( -1 );
	m_stGPSSpeed->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSSpeed->SetToolTip( _("Log Speed") );

	fgSizer2211112->Add( m_stGPSSpeed, 0, wxALL, 1 );

	m_staticText81111111 = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("Kts "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText81111111->Wrap( -1 );
	m_staticText81111111->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer2211112->Add( m_staticText81111111, 0, wxALL, 1 );

	m_stGPSETA = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("000.0"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSETA->Wrap( -1 );
	m_stGPSETA->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSETA->SetToolTip( _("ETA") );

	fgSizer2211112->Add( m_stGPSETA, 0, wxALL, 1 );

	m_staticTextKnots111111111 = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("ETA "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots111111111->Wrap( -1 );
	m_staticTextKnots111111111->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer2211112->Add( m_staticTextKnots111111111, 0, wxALL, 1 );

	m_stGPSDistance = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("000.0"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSDistance->Wrap( -1 );
	m_stGPSDistance->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSDistance->SetToolTip( _("Log Speed") );

	fgSizer2211112->Add( m_stGPSDistance, 0, wxALL, 1 );

	m_staticText18121111 = new wxStaticText( sbLongS2->GetStaticBox(), wxID_ANY, _("N Mi"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText18121111->Wrap( -1 );
	m_staticText18121111->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer2211112->Add( m_staticText18121111, 0, wxALL, 1 );


	sbLongS2->Add( fgSizer2211112, 1, wxEXPAND, 5 );


	fgSizer2881->Add( sbLongS2, 1, wxEXPAND, 2 );

	wxStaticBoxSizer* sbLongS12;
	sbLongS12 = new wxStaticBoxSizer( new wxStaticBox( m_panelGPS, wxID_ANY, _("Position") ), wxVERTICAL );

	wxFlexGridSizer* fgSizer22111112;
	fgSizer22111112 = new wxFlexGridSizer( 0, 8, 0, 0 );
	fgSizer22111112->SetFlexibleDirection( wxBOTH );
	fgSizer22111112->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_stGPSLatD1 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLatD1->Wrap( -1 );
	m_stGPSLatD1->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLatD1->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLatD1, 0, wxALL, 1 );

	m_stGPSLatD1m = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLatD1m->Wrap( -1 );
	m_stGPSLatD1m->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLatD1m->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLatD1m, 0, wxALL, 1 );

	m_stGPDLatD1s = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPDLatD1s->Wrap( -1 );
	m_stGPDLatD1s->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPDLatD1s->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPDLatD1s, 0, wxALL, 1 );

	m_staticTextKnots11111111132 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("Lat. "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots11111111132->Wrap( -1 );
	m_staticTextKnots11111111132->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer22111112->Add( m_staticTextKnots11111111132, 0, wxALL, 1 );

	m_stGPSLongD1 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLongD1->Wrap( -1 );
	m_stGPSLongD1->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLongD1->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLongD1, 0, wxALL, 1 );

	m_stGPSLongD1m = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLongD1m->Wrap( -1 );
	m_stGPSLongD1m->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLongD1m->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLongD1m, 0, wxALL, 1 );

	m_stGPSLongD1s = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLongD1s->Wrap( -1 );
	m_stGPSLongD1s->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLongD1s->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLongD1s, 0, wxALL, 1 );

	m_staticTextKnots111111111122 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("Long."), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots111111111122->Wrap( -1 );
	m_staticTextKnots111111111122->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer22111112->Add( m_staticTextKnots111111111122, 0, wxALL, 1 );


	fgSizer22111112->Add( 0, 0, 1, wxEXPAND, 5 );

	m_stGPSLatD2 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLatD2->Wrap( -1 );
	m_stGPSLatD2->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLatD2->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLatD2, 0, wxALL, 1 );

	m_stGPSLatD2m = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLatD2m->Wrap( -1 );
	m_stGPSLatD2m->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLatD2m->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLatD2m, 0, wxALL, 1 );

	m_staticTextKnots111111111222 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("Lat. "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots111111111222->Wrap( -1 );
	m_staticTextKnots111111111222->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer22111112->Add( m_staticTextKnots111111111222, 0, wxALL, 1 );


	fgSizer22111112->Add( 0, 0, 1, wxEXPAND, 5 );

	m_stGPSLongD2 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLongD2->Wrap( -1 );
	m_stGPSLongD2->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLongD2->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLongD2, 0, wxALL, 1 );

	m_stGPSLongDm = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("00.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLongDm->Wrap( -1 );
	m_stGPSLongDm->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLongDm->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLongDm, 0, wxALL, 1 );

	m_staticTextKnots1111111111122 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("Long."), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots1111111111122->Wrap( -1 );
	m_staticTextKnots1111111111122->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer22111112->Add( m_staticTextKnots1111111111122, 0, wxALL, 1 );
	...
	m_stGPSLatD3 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("000.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLatD3->Wrap( -1 );
	m_stGPSLatD3->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLatD3->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLatD3, 0, wxALL, 1 );

	m_staticTextKnots1111111112112 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("Lat. "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots1111111112112->Wrap( -1 );
	m_staticTextKnots1111111112112->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer22111112->Add( m_staticTextKnots1111111112112, 0, wxALL, 1 );
	...
	m_stGPSLongD3 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("000.000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stGPSLongD3->Wrap( -1 );
	m_stGPSLongD3->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );
	m_stGPSLongD3->SetToolTip( _("Vessel Heading") );

	fgSizer22111112->Add( m_stGPSLongD3, 0, wxALL, 1 );

	m_staticTextKnots11111111111112 = new wxStaticText( sbLongS12->GetStaticBox(), wxID_ANY, _("Long."), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextKnots11111111111112->Wrap( -1 );
	m_staticTextKnots11111111111112->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxT("Arial") ) );

	fgSizer22111112->Add( m_staticTextKnots11111111111112, 0, wxALL, 1 );


	sbLongS12->Add( fgSizer22111112, 1, wxEXPAND, 5 );


	fgSizer2881->Add( sbLongS12, 1, wxEXPAND, 2 );


	fgSizer10813->Add( fgSizer2881, 1, wxEXPAND, 5 );

	wxStaticBoxSizer* sbSizer53311;
	sbSizer53311 = new wxStaticBoxSizer( new wxStaticBox( m_panelGPS, wxID_ANY, _("Message Selection") ), wxVERTICAL );
	...
	fgSizer10813->Add( sbSizer53311, 1, wxEXPAND, 2 );
	...
	m_staticText13432 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º \"C\""), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText13414 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º '\"C\""), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText1344 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º \"A\""), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText13422 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º \"A\""), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText13311 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º \"A\""), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText134321 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º \"C\""), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText1343211 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º \"C\""), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText1342112 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText13421111 = new wxStaticText( sbSizer6611->GetStaticBox(), wxID_ANY, _("º"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_spS_HDG = new wxSpinCtrlDouble( sbSizer452->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS|wxSP_WRAP, -25, 25, 0.000000, 0.1 );
	...
	m_spS_Set = new wxSpinCtrlDouble( sbSizer452->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS|wxSP_WRAP, 0, 359.9, 0.000000, 0.1 );
	m_spS_Set->SetDigits( 1 );
	m_spS_Set->SetToolTip( _("To adjust Set (Drift bearing) 0-360 ºtrue") );

	fgSizer489->Add( m_spS_Set, 0, wxALL, 2 );
	...
	m_spS_D_Drift = new wxSpinCtrlDouble( sbSizer452->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 38, 0.000000, 0.1 );
	m_spS_D_Drift->SetDigits( 1 );
	m_spS_D_Drift->SetToolTip( _("To adjust Drift Speed -38/+38 Kts") );

	fgSizer489->Add( m_spS_D_Drift, 0, wxALL, 2 );
	...
	sbSizer453 = new wxStaticBoxSizer( new wxStaticBox( m_panelTest, wxID_ANY, _("Selector") ), wxVERTICAL );
	...
	m_staticTDBT = new wxStaticText( sbSizer454->GetStaticBox(), wxID_ANY, _("DBT"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTDBT->Wrap( -1 );
	m_staticTDBT->SetToolTip( _("Depth Below Trasducer (Sounder)") );

	fgSizer48111->Add( m_staticTDBT, 0, wxALL, 2 );

	m_spS_DBT = new wxSpinCtrlDouble( sbSizer454->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 13000, 2, 0.1 );
	m_spS_DBT->SetDigits( 1 );
	m_spS_DBT->SetToolTip( _("Set Depth Below Transducer ") );

	fgSizer48111->Add( m_spS_DBT, 0, wxALL, 2 );

	m_staticText1343112 = new wxStaticText( sbSizer454->GetStaticBox(), wxID_ANY, _("m (SI)"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_spS_DPT = new wxSpinCtrlDouble( sbSizer454->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS|wxSP_WRAP, 0, 90, 3, 0.1 );
	m_spS_DPT->SetDigits( 1 );
	m_spS_DPT->SetToolTip( _("Set Water Depth, usually it is really the depth Below Transducer + Fixed Distance from Transduce to waterline") );

	fgSizer48111->Add( m_spS_DPT, 0, wxALL, 2 );
	...
	m_cbAWA211->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( SimulatorBase::OnUpdate ), NULL, this );
...
SimulatorBase::~SimulatorBase()
{
	...
	m_cbAWA211->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( SimulatorBase::OnUpdate ), NULL, this );
